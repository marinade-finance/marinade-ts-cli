 ...
 * Article at: https://www.justin-credible.net/2023/12/04/locking-in-typescript/
 */
 ...
 * @returns A promise that resolves once the given number of milliseconds has elapsed.
 */
